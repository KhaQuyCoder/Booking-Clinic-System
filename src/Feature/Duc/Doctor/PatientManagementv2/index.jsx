...
const PatientTable = () => {
  ...
  return (
    <Paper className="patient-management-wrap" sx={{ mt: 3, p: 2, 
        boxShadow: "0px 4px 20px rgba(0,0,0,0.2)", // thay đổi box-shadow
        borderRadius: "12px" // có thể bo góc nếu muốn
       }}>
