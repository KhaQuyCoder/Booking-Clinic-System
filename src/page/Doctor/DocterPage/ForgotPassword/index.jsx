...
import accounts from "../../../../data/account.json"; // dữ liệu account
...
const ForgotPassword = ({ onBack }) => {
  ...
  const [step, setStep] = useState(1); // step 1: nhập phone, step 2: đổi mật khẩu
  ...
  const handleChangePassword = (e) => {
    ...
    if (accountIndex !== -1) {
      ...
      setTimeout(() => onBack(), 2000); // quay về login sau 2s
    }
  };
      ...
      <div className="login-box">
        ...
        {step === 1 && (
          <form onSubmit={handleCheckPhone}>
            <h2>Quên mật khẩu</h2>
            <p className="form-text">Nhập số điện thoại để xác nhận tài khoản của bạn</p>
            <input
              type="text"
            ...
            <div className="links">
              <a href="#" onClick={onBack}>Quay lại đăng nhập</a>
            </div>
          </form>
        )}
